...
# this script trains an oracle model. In our experiments, this training resulted in validation score of 5.89 at epoch 80
...
train_dir=${src}/oracle_models/5.89
...
cp -r ${datagen_root}/8 ${datagen_root}/10 ${datagen_root}/hard1 ${datagen_root}/hard4 ${datagen_root}/hard5 ${datagen_root}/hard6 ${train_data}
